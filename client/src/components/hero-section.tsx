      ...
      <div className="relative z-10 container mx-auto px-4 pt-32 pb-16">
        <div className="text-center">
          ...
          <div className="mb-8 animate-float">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8" data-testid="hero-subtitle">
              {t('heroSubtitle')}
            </p>
          </div>
          ...
          <a 
            ...
            className="inline-block px-8 py-4 bg-gradient-to-r from-secondary to-accent text-white font-semibold rounded-full hover:scale-105 transform transition-all duration-300 animate-glow"
